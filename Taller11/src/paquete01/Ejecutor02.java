...
public class Ejecutor02 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < datos001.length; i++) {
            ...
            Menu mN = new MenuNinos(nombre, valorInicial, valorHelado, 
                    valorPastel);
            lista.add(mN);
        ...
        for (int i = 0; i < datos003.length; i++) {
            ...
            Menu mD = new MenuDia(nombre, valorInicial, valorPostre, 
                    valorBebida);
            lista.add(mD);
        }

        for (int i = 0; i < datos004.length; i++) {
            String nombre = datos004[i][0];
            ...
            Menu mC = new MenuCarta(nombre, valorInicial, 
